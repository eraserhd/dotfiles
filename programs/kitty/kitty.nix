...
buildPythonApplication rec {
  ...
  # Required for test_ssh_login_shell_detection, default value is to large for ouput of `env`.
  patches = [
    ...
    ./zsh-compinit.patch
    # Skip `test_ssh_login_shell_detection`, build users have their shell set to `/bin/nologin`
    # which causes issues.
